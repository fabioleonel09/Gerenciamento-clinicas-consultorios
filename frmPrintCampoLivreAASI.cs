...
namespace segmentoOtoneurologia
{
    ...
    {
        public frmPrintCampoLivreAASI(string valor1)
        {
            InitializeComponent();

            txtPacienteAudioCampoAASI.Text = valor1;

            tabelaExamesBindingSource.Filter = $"identificacao like '*{txtPacienteAudioCampoAASI.Text}*'";
